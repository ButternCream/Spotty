...
- !tracking - returns the unique db id of an entry along with the playlist name
- !stop <id> - Stop tracking the specified playlist. Where id will be the specified unique id from !tracking
...
!stop - Stop the current channel from tracking anything
!stopall - Removes ALL of your tracking entries to the database
